...
## 📌 Project Overview
A real-world Ansible project to implement Static Route Setup. Focuses on Network best practices.
...
- Automate repetitive tasks related to Static Route Setup.
