...
## 📌 Project Overview
A Python DevOps script to implement Screen Capture Tool. Useful for Web.
...
- Automate repetitive tasks related to Screen Capture Tool.
