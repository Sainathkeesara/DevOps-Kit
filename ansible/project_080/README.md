...
## 📌 Project Overview
A real-world Ansible project to implement Lynis Security Audit. Focuses on Cloud best practices.
...
- Automate repetitive tasks related to Lynis Security Audit.
