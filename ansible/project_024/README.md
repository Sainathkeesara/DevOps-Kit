...
## 📌 Project Overview
A real-world Ansible project to implement Samba File Server. Focuses on Cloud best practices.
...
- Automate repetitive tasks related to Samba File Server.
