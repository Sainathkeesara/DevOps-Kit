...
## 📌 Project Overview
A Python DevOps script to implement Image Resizer Tool. Useful for Network.
...
- Automate repetitive tasks related to Image Resizer Tool.
