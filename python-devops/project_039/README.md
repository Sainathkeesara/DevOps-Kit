...
## 📌 Project Overview
A Python DevOps script to implement RDS Snapshot Manager. Useful for Web.
...
- Automate repetitive tasks related to RDS Snapshot Manager.
