...
## 📌 Project Overview
A real-world Ansible project to implement K3s Lightweight K8s. Focuses on Monitoring best practices.
...
- Automate repetitive tasks related to K3s Lightweight K8s.
