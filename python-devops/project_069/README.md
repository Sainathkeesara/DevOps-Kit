...
## 📌 Project Overview
A Python DevOps script to implement Selenium Automator. Useful for Cloud.
...
- Automate repetitive tasks related to Selenium Automator.
