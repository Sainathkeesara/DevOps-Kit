...
## 📌 Project Overview
A Python DevOps script to implement Route53 Record Manager. Useful for Security.
...
- Automate repetitive tasks related to Route53 Record Manager.
